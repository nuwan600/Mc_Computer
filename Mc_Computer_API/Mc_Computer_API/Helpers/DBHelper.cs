...
namespace Mc_Computer_API.Helpers
{
    public class DBHelper
    {

        private static readonly string connectionString = ConfigurationManager.ConnectionStrings["McConnStringDb1"].ConnectionString;
